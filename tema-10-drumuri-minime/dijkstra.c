//Realizați drumul de cost  minim de la un nod ales sursa pana la un altul folosind algoritmul Dijkstra. 
...
//Graful 1
    ...
    printf("Distanta de la nodul %d la nodul %d in graful 1 este: %d\n", start, finish, Djikstra(graph, (unsigned int)start, (unsigned int)finish));
...
//Graf 2
    ...
    printf("Distanta de la nodul %d la nodul %d in graful 2 este: %d\n", start, finish, Djikstra(graph2, (unsigned int)start, (unsigned int)finish));
